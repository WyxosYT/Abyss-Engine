...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function create()
	{
        ...
        key_space.loadGraphic(Paths.image("android/key_space",'shared')); //"assets/images/key_space.png"
        key_space.alpha = 0.75;
        add(key_space);

        key_shift = new FlxButton(60, 200, "");
        key_shift.loadGraphic(Paths.image("android/key_shift",'shared')); //"assets/images/key_shift.png"
