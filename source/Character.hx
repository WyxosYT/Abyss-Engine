	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				...
				{
					tex = Paths.getSparrowAtlas('gf/DOGE_gf');
					frames = tex;
				}
				if (data.abyss.data.isgenderswapbf)
				{
					tex = Paths.getSparrowAtlas('gf/GENDERSWAP_bf');
					frames = tex;
				}
			...
			case 'gf-christmas':
				...
				if (data.abyss.data.isdogegf)
				{
					tex = Paths.getSparrowAtlas('gf/DOGE_gfChristmas');
					frames = tex;
				}
				if (data.abyss.data.isgenderswapbf)
				{
					tex = Paths.getSparrowAtlas('gf/GENDERSWAP_bfChristmas');
					frames = tex;
				}
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
			...
			case 'gf-car':
				...
				if (data.abyss.data.isdogegf)
				{
					tex = Paths.getSparrowAtlas('gf/DOGE_gfCar');
					frames = tex;
				}
				if (data.abyss.data.isgenderswapbf)
				{
					tex = Paths.getSparrowAtlas('gf/GENDERSWAP_bfCar');
					frames = tex;
				}
			...
			case 'gf-pixel':
				...
				if (data.abyss.data.isdogegf)
				{
					tex = Paths.getSparrowAtlas('gf/DOGE_gfPixel');
					frames = tex;
				}
				if (data.abyss.data.isgenderswapbf)
				{
					tex = Paths.getSparrowAtlas('gf/GENDERSWAP_bfPixel');
					frames = tex;
				}
			...
			case 'bf':
				...
				{
					var tex = Paths.getSparrowAtlas('bf/DSIDES_bf');
					frames = tex;
				}
				if (data.abyss.data.isgenderswapgf)
				{
					var tex = Paths.getSparrowAtlas('bf/GENDERSWAP_gf');
					frames = tex;
				}
			...
			case 'bf-christmas':
				...
				if (data.abyss.data.isgenderswapgf)
				{
					var tex = Paths.getSparrowAtlas('bf/GENDERSWAP_gfChristmas');
					frames = tex;
				}
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
			...
			case 'bf-car':
				...
				if (data.abyss.data.isdsidesbf)
				{
					var tex = Paths.getSparrowAtlas('bf/DSIDES_bfCar');
					frames = tex;
				}
				if (data.abyss.data.isgenderswapgf)
				{
					var tex = Paths.getSparrowAtlas('bf/GENDERSWAP_gfCar');
					frames = tex;
				}
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
			...
			case 'bf-pixel':
				...
				if (data.abyss.data.isgenderswapgf)
				{
					var tex = Paths.getSparrowAtlas('bf/GENDERSWAP_gfPixel');
					frames = tex;
				}
			...
			case 'bf-pixel-dead':
				...
				if (data.abyss.data.isgenderswapgf)
				{
					frames = Paths.getSparrowAtlas('bf/GENDERSWAP_gfPixelsDead');
				}
