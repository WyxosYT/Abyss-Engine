...
class Hitbox extends FlxSpriteGroup
{
	...
	public function new(?widghtScreen:Int)
	{
		...
		var hitbox_hint:FlxSprite = new FlxSprite(0, 0).loadGraphic('assets/shared/images/android/hitbox_hint.png');
	...
	public function createhitbox(X:Float, framestring:String) {
		...
		var frames = FlxAtlasFrames.fromSparrow('assets/shared/images/android/hitbox.png', 'assets/shared/images/android/hitbox.xml');
